export default function LoadingRegistrosNeumaticos() {
  return (
    <div className="flex flex-col h-full space-y-6 p-4 md:p-6 lg:p-8 antialiased animate-pulse">
      <header className="flex items-center justify-between border-b border-white/5 pb-4">
        <div className="mx-auto flex w-full max-w-6xl items-center gap-4 px-4 py-3">
          <div className="h-8 w-8 rounded border border-white/10 bg-violet-500/10" />
          <div className="space-y-2">
            <div className="h-6 w-56 rounded bg-violet-500/10" />
