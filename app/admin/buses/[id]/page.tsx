...
/**
 * Ficha de Detalle del Vehículo — Server Component.
 *
 * Ruta: /admin/buses/[id]
 * Muestra:
 * - Información general del vehículo (patente, marca, modelo, año, asientos)
 * - Previsualización del chasis
 * - Anillos circulares prominentes para Rev. Técnica y Seguro
 */
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="mx-auto max-w-4xl px-4 py-6 space-y-6">
        {/* Sección: Información General + Chasis */}
        ...
        {/* Sección: Vigencias Legales — Anillos Circulares */}
        <div className="rounded-2xl border border-slate-700/50 bg-slate-800/60 p-6">
...
/**
 * Componente auxiliar para mostrar un par label/value en la ficha.
 */
