    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Tarjeta: Centro de Inteligencia */}
          <a
            href="/admin/inteligencia"
            className="group rounded-xl border border-amber-500/20 bg-gradient-to-br from-slate-800/60 to-amber-500/5 p-6 transition-all hover:border-amber-500/40 hover:shadow-lg hover:shadow-amber-500/10"
          >
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-amber-600/20 text-amber-400 transition-colors group-hover:bg-amber-600/30">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-white">🧠 Centro de Inteligencia</h3>
            <p className="mt-1 text-sm text-slate-400">Antirrobo, auditoría y análisis de eficiencia</p>
          </a>
        </div>
      </main>
    </div>
