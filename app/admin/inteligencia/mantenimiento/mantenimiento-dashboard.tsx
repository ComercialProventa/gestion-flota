    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="mb-4">
          <h2 className="text-base font-bold text-white flex items-center gap-2">
            ⚠️ Alertas de Frecuencia de Cambios
          </h2>
        ...
        {anomalias.length === 0 ? (
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {anomalias.map((a) => (
              <div key={a.id} className="rounded-xl border border-red-500/30 bg-red-500/5 p-5 relative overflow-hidden flex gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-red-600/20 text-red-500 animate-pulse">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          <div className="rounded-xl border border-slate-700/50 bg-slate-800/40 p-5 flex flex-col justify-center text-center">
          ...
          <div className="lg:col-span-3 rounded-2xl border border-slate-700/50 bg-slate-800/50 p-6 overflow-x-auto">
            {gastos.length === 0 ? (
                ...
                {gastos.map((g, i) => {
                  ...
                  return (
                    <div key={g.busId} className="flex items-center gap-4">
                      ...
                      <div className="flex-1 relative h-6 rounded bg-slate-900 overflow-hidden border border-slate-700/30">
                        <div
